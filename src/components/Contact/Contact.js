...
const style = {
    ...
    input: "px-3 py-2 border border-[#6db2c7fd] rounded-md focus:outline-[#6db2c7fd]",
...
const Contact = ({ refs }) => {
    ...
    const onClick = (e) => {
        ...
        emailjs.sendForm('service_e881k66', 'template_m1sx30e', form.current, '0_jnJPrBMQvt3fMaw')
            .then((result) => {
    ...
    return (
        <>
            <div ref={refs} className="bg-gray-100 gruppo flex flex-col items-center justify-center pb-14">
                        ...
                        <form ref={form} className="flex flex-col" onSubmit={(e) => onClick(e)}>
                            ...
                            <div className="flex space-y-2 flex-col">
                                <div className={style.inputBlock}>
                                    ...
                                    <input className={style.input} placeholder="Enter your email" name="email" type="email" required />
                                </div>
                                <div className={style.inputBlock}>
                                    <label className="text-lg">Subject</label>
                                    <input className={style.input} placeholder="Enter subject" name="subject" type="text" required />
                                </div>
                                <div className={style.inputBlock}>
                                    <label className="text-lg">Message</label>
                                    <textarea className={`${style.input} h-[200px] resize-none`} name="message" placeholder="Enter message" required />
                                </div>
                            </div>
                            <div className="py-4 ml-auto font-bold">
                                <button type="submit" className="border-2 transition shadow-md duration-100 px-5 py-2 rounded border-[#6db2c7fd] bg-[#6db2c7fd] hover:bg-[#7abed3fd] hover:text-white">Send</button>
                            </div>
                        </form>
                    </div>
                </div>
